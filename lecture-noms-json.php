<?php 
//lecture du contenu d'un fichier GET contenu
$data = file_get_contents("data/noms.json");

//explode() -> wie split() in JS :
//um string zu einem array zu convertieren und den Separator definieren
//POUR RETURN SPRUNG \n ..... \r\n pour pc
//$list= explode("\r\n", $data); json_encode/json_decode au lieu de explode()/emplode()
//SERIALISATION/DESERIALISATION

//true pour array associatif (chaine de caractere), sinon par défaut transformation en objet ;
...
if($isPosted){ 
    ...
    //var_dump($name);
        ...
        $listAsString = json_encode($list);

        //PUT contenu
        file_put_contents("data/noms.json", $listAsString);
